...
class FilesController {
  ...
  static async postUpload(request, response) {
    ...
    // The user based on the token Retrieve
  ...
  // GET /files/:id and Return file by fileId
  ...
  // GET /files and Return the files attached to the user
